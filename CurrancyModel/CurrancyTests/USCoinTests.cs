...
namespace CurrencyTests
{
    ...
    public class USCoinTests
    {
        ...
        public void USCoinPennyConstructor()
        {
            ...
            //Assert
            Assert.AreEqual(CurrencyModel.Currency.US.USCoinMintMark.D, p.MintMark); //D is the default mint mark
        ...
        public void USCoinMintMark()
        {
            ...
            D = CurrencyModel.Currency.US.USCoinMintMark.D;
            P = CurrencyModel.Currency.US.USCoinMintMark.P;
            S = CurrencyModel.Currency.US.USCoinMintMark.S;
            W = CurrencyModel.Currency.US.USCoinMintMark.W;
